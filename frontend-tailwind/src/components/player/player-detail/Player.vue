<template lang="pug">
  div(v-if="loaded")
    dl(class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4")
      StatCard(label="Résultat total" :stat="playerTotalResult + '€'" :change="lastSessionResult" :color-class="playerTotalResult >= 0 ? 'bg-green-500' : 'bg-red-500'")
    ...
    dl(class="lg:mt-14 mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4")
      ...
      StatCard(label="Pire session" :stat="worstResult + '€'" color-class="bg-red-500")
      ...
      StatCard(label="Dernières places" :stat="lastPlaces" color-class="bg-red-500")
